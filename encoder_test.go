...
func TestPadding(t *testing.T) {
	assertEncoded(t, New(9).Padding(1), []byte{0x7f})
	assertEncoded(t, New(9).Padding(2), []byte{0x7f, 0x7f})
}

func TestNil(t *testing.T) {
	assertEncoded(t, New(9).Nil(), []byte{0x6f})
}

func TestIntSmall(t *testing.T) {
	assertEncoded(t, New(9).Int(0), []byte{0})
	assertEncoded(t, New(9).Int(1), []byte{1})
	assertEncoded(t, New(9).Int(104), []byte{104})
...
func TestInt8(t *testing.T) {
	assertEncoded(t, New(9).Int(107), []byte{0x6a, 0x6b})
	assertEncoded(t, New(9).Int(-107), []byte{0x7a, 0x6b})
	assertEncoded(t, New(9).Int(255), []byte{0x6a, 0xff})
	assertEncoded(t, New(9).Int(-255), []byte{0x7a, 0xff})

}

func TestInt16(t *testing.T) {
	assertEncoded(t, New(9).Int(0x100), []byte{0x6b, 0x00, 0x01})
	assertEncoded(t, New(9).Int(0x7fff), []byte{0x6b, 0xff, 0x7f})
	assertEncoded(t, New(9).Int(-0x7fff), []byte{0x7b, 0xff, 0x7f})
	assertEncoded(t, New(9).Int(0xffff), []byte{0x6b, 0xff, 0xff})
	assertEncoded(t, New(9).Int(-0xffff), []byte{0x7b, 0xff, 0xff})
}

func TestInt32(t *testing.T) {
	assertEncoded(t, New(9).Int(0x10000), []byte{0x6c, 0x00, 0x00, 0x01, 0x00})
	assertEncoded(t, New(9).Int(0x7fffffff), []byte{0x6c, 0xff, 0xff, 0xff, 0x7f})
	assertEncoded(t, New(9).Int(-0x7fffffff), []byte{0x7c, 0xff, 0xff, 0xff, 0x7f})
	assertEncoded(t, New(9).Int(0xffffffff), []byte{0x6c, 0xff, 0xff, 0xff, 0xff})
	assertEncoded(t, New(9).Int(-0xffffffff), []byte{0x7c, 0xff, 0xff, 0xff, 0xff})
}

func TestInt64(t *testing.T) {
	assertEncoded(t, New(9).Int(0x100000000), []byte{0x6d, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00})
	assertEncoded(t, New(9).Int(0x7fffffffffffffff), []byte{0x6d, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f})
	assertEncoded(t, New(9).Int(-0x7fffffffffffffff), []byte{0x7d, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f})
}

func TestFloat64(t *testing.T) {
	assertEncoded(t, New(9).Float(1.0123), []byte{0x73, 0x51, 0xda, 0x1b, 0x7c, 0x61, 0x32, 0xf0, 0x3f})
}
